...
def mock_team_state() -> TeamState:
    ...
    return TeamState(
        name="Team X",
        goal=create_location("Location A", 0.0, 0.0),
        solved={},
    )
